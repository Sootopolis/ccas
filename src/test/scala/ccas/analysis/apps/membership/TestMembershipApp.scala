...
object TestMembershipApp extends ZIOSpecDefault {
  ...
  private val club   = Club(clubId, Times.t0, ClubSlug("test-club"), "Test Club", None)
  ...
  private val otherClub   = Club(otherClubId, Times.t0, ClubSlug("other-club"), "Other Club", None)
