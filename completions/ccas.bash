  ...
  case "$cmd" in
    ...
    server)
      case "$sub" in
        ...
        up) opts="--detach -d --ready-timeout-seconds" ;;
        down)  ;;
        status)  ;;
        *) COMPREPLY=(); return ;;
      esac ;;
